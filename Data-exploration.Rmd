...
d<-tmap_arrange(PUD500m.p,TUD500m.p, b, ncol = 2)
d
...
a<-ggplot() +
  ...
  theme(legend.position = c(0.25, 0.3), legend.margin = margin(-0.25,0,0,0, unit="cm"), panel.background = element_rect(fill = "aliceblue", color = NA), axis.title.x=element_blank(), axis.title.y=element_blank(), legend.text=element_text(size=7), legend.title=element_text(size=8), plot.margin=unit(c(0.1,0.1,0.1,0.1),"cm"))
...
b<-ggplot() +
  ...
  geom_sf_label(data = cdp, aes(label=NAME), size=2.5) +
  coord_sf(xlim=c(-122.5402,-122.3882),ylim=c(37.38338,37.5586), datum = NA) +
  theme(legend.position = c(0.25, 0.24), panel.background = element_rect(fill = "aliceblue", color = NA), axis.title.x=element_blank(), axis.title.y=element_blank(), legend.text=element_text(size=7), legend.title=element_text(size=8), plot.margin=unit(c(0.1,0.1,0.1,0.1),"cm"))
...
levels(ESI_bbox$I1)
ESI_bbox$I1<-fct_recode(ESI_bbox$I1,"Rocky shore"="1A","Solid man-made structures"="1B","Wave-cut platforms in bedrock"="2A","Scarps and steep slopes"="2B", "Fine-to-medium grain sand beaches"="3A", "Scarps and steep slopes"="3B","Coarse-grained sand beaches"="4","Mixed sand and gravel beaches"="5","Gravel Beaches"="6A","Riprap"="6B","Boulder Rubble"="6D","Tidal flats"="7","Rocky shores"="8A","Solid man-made structures"="8B","Riprap"="8C","Tidal flat"="9A","Vegetated low riverine banks"="9B","Salt and brackish marshes"="10A")
ESI_bbox$I2<-fct_recode(ESI_bbox$I2,"Rocky shore"="1A","Solid man-made structures"="1B","Wave-cut platforms in bedrock"="2A","Scarps and steep slopes"="2B", "Fine-to-medium grain sand beaches"="3A", "Scarps and steep slopes"="3B","Coarse-grained sand beaches"="4","Mixed sand and gravel beaches"="5","Gravel Beaches"="6A","Riprap"="6B","Boulder Rubble"="6D","Tidal flats"="7","Rocky shores"="8A","Solid man-made structures"="8B","Riprap"="8C","Tidal flat"="9A","Vegetated low riverine banks"="9B","Salt and brackish marshes"="10A")
coler1<-brewer.pal(11,"Paired")
#coler2<-coler1[2:4]
...
c<-ggplot() +
  ...
  scale_color_manual(values = coler1, name = "ESI Classes", guide = guide_legend(override.aes = list(shape = NA))) +
  coord_sf(xlim=c(-122.5,-122.4),ylim=c(37.47121,37.51164), datum = NA) + #bbox_new
  theme(panel.background = element_rect(fill = "aliceblue", color = NA), axis.title.x=element_blank(), axis.title.y=element_blank(), legend.text=element_text(size=7), legend.title=element_text(size=8), legend.position = c(0.75, 0.55), plot.margin=unit(c(0.1,0.1,0.1,0.1),"cm"))
