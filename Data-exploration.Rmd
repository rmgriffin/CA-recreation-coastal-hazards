...
bp.1<-cbind(df[df$source=="TUD"&df$hres==250,"ud"],(as.vector(predict(models[['Poisson']]))))
...
ggplot(bp.1) + 
  stat_bin(aes(x=ud, fill=status), position = position_dodge(preserve = "single"), breaks = seq(-2, 20, by = 1), title(Poisson)) +
  scale_x_continuous(limits = c(-2,20)) +
  theme_minimal()

bp.2<-cbind(df[df$source=="TUD"&df$hres==250,"ud"],(as.vector(predict(models[['Quasi-Poisson']]))))
...
ggplot(bp.2) + 
  stat_bin(aes(x=ud, fill=status), position = position_dodge(preserve = "single"), breaks = seq(-5, 20, by = 1), title("Quasi-Poisson")) +
  scale_x_continuous(limits = c(-5,20)) +
  theme_minimal()

bp.3<-cbind(df[df$source=="TUD"&df$hres==250,"ud"],(as.vector(predict(models[['Negative Binomial']]))))
...
ggplot(bp.3) + 
  stat_bin(aes(x=ud, fill=status), position = position_dodge(preserve = "single"), breaks = seq(-7, 20, by = 1), title("Negative Binomial")) +
  scale_x_continuous(limits = c(-7,20)) +
  theme_minimal()

bp.4<-cbind(df[df$source=="TUD"&df$hres==250,"ud"],(as.vector(predict(models[['Hurdle']]))))
...
ggplot(bp.4) + 
  stat_bin(aes(x=ud, fill=status), position = position_dodge(preserve = "single"), breaks = seq(-3, 20, by = 1), title("Hurdle")) +
  scale_x_continuous(limits = c(-3,20)) +
  theme_minimal()

bp.5<-cbind(df[df$source=="TUD"&df$hres==250,"ud"],(as.vector(predict(models[['Zero-inflated Negative Binomial']]))))
...
ggplot(bp.5) + 
  stat_bin(aes(x=ud, fill=status), position = position_dodge(preserve = "single"), breaks = seq(-1, 20, by = 1), title("Zero-inflated Negative Binomial")) +
