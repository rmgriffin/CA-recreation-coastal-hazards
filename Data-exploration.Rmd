...
# Moran's I calculation https://cran.r-project.org/web/packages/adespatial/vignettes/tutorial.html https://rpubs.com/FelipeSantos/LISA_tmap_geoda

nb.PUD<-poly2nb(df250PUD)
nb.list.PUD<-nb2listw(nb.PUD, zero.policy = TRUE)
...
MC.DC<-moran.mc(df250DC$DCres,nb.list.DC,nsim = 999,zero.policy = TRUE)
MC.DC
