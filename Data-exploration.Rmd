...
# Packages
PKG <- c("tidyverse","knitr", "renv", "modelsummary", "kableExtra", "corrplot","RColorBrewer","lmtest","sandwich","pscl", "glmmTMB", "broom.mixed","vcd", "lmtest", "sf", "tmap", "tigris", "patchwork") 
...
sm<-nation(resolution = "5m")
sm<-st_transform(sm, st_crs(Rds))

PUD500m$PUD_b<-cut(PUD500m$PUD_YR_AVG,
                      breaks = c(0, 100, 200, 300, 400, 500, 600), labels = c("0-100","100-200","200-300","300-400","400-500","500-600"))
...
ggplot() +
  ...
  theme(legend.position = c(0.25, 0.2), legend.margin = margin(-0.85,0,0,0, unit="cm"), panel.background = element_rect(fill = "aliceblue", color = NA), axis.title.x=element_blank(), axis.title.y=element_blank())
