...
Pois.reg<-function(tipe,dv){ # tipe is either "PUD","TUD","DC" / rs is one of {25, 500, 1000} / dv is either "ud" or "ihsud" or "lnud"
  models <- list()
  models.rob<-list()
  models[['p250']]<-glm(reformulate(termlabels = c("RockyShore","SandyBeach","Marshes","Armored","sumpop","rdist","BIKE_PATH","BOATING","BT_FACIL_T","CAMPGROUND","DSABLDACSS","FEE","FISHING","PARKING","PTH_BEACH","RESTROOMS","STRS_BEACH","WaterTrail","BayTrail","ChA","meanat"),response = dv), data = df[df$source==tipe&df$hres==250,], family = poisson)
  models.rob[['p250']]<-coeftest(models[['p250']], vcov = sandwich)
  
  models[['p500']]<-glm(reformulate(termlabels = c("RockyShore","SandyBeach","Marshes","Armored","sumpop","rdist","BIKE_PATH","BOATING","BT_FACIL_T","CAMPGROUND","DSABLDACSS","FEE","FISHING","PARKING","PTH_BEACH","RESTROOMS","STRS_BEACH","WaterTrail","BayTrail","ChA","meanat"),response = dv), data = df[df$source==tipe&df$hres==500,], family = poisson)
  models.rob[['p500']]<-coeftest(models[['p500']], vcov = sandwich)
  
  models[['p1000']]<-glm(reformulate(termlabels = c("RockyShore","SandyBeach","Marshes","Armored","sumpop","rdist","BIKE_PATH","BOATING","BT_FACIL_T","CAMPGROUND","DSABLDACSS","FEE","FISHING","PARKING","PTH_BEACH","RESTROOMS","STRS_BEACH","WaterTrail","BayTrail","ChA","meanat"),response = dv), data = df[df$source==tipe&df$hres==1000,], family = poisson)
...
OLS.reg<-function(tipe,dv){ # tipe is either "PUD","TUD","DC" / rs is one of {25, 500, 1000} / dv is either "ud" or "ihsud" or "lnud"
  models <- list()
  models.rob<-list()
  models[['p250']]<-lm(reformulate(termlabels = c("RockyShore","SandyBeach","Marshes","Armored","sumpop","rdist","BIKE_PATH","CAMPGROUND","DSABLDACSS","FEE","FISHING","PARKING","PTH_BEACH","RESTROOMS","STRS_BEACH","WaterTrail","BayTrail","ChA","meanat"),response = dv), data = df[df$source==tipe&df$hres==250,])
  models.rob[['p250']]<-coeftest(models[['p250']], vcov = sandwich)
  
  models[['p500']]<-lm(reformulate(termlabels = c("RockyShore","SandyBeach","Marshes","Armored","sumpop","rdist","BIKE_PATH","CAMPGROUND","DSABLDACSS","FEE","FISHING","PARKING","PTH_BEACH","RESTROOMS","STRS_BEACH","WaterTrail","BayTrail","ChA","meanat"),response = dv), data = df[df$source==tipe&df$hres==500,])
  models.rob[['p500']]<-coeftest(models[['p500']], vcov = sandwich)
  
  models[['p1000']]<-lm(reformulate(termlabels = c("RockyShore","SandyBeach","Marshes","Armored","sumpop","rdist","BIKE_PATH","CAMPGROUND","DSABLDACSS","FEE","FISHING","PARKING","PTH_BEACH","RESTROOMS","STRS_BEACH","WaterTrail","BayTrail","ChA","meanat"),response = dv), data = df[df$source==tipe&df$hres==1000,])
  models.rob[['p1000']]<-coeftest(models[['p1000']], vcov = sandwich)

  return(list(models,models.rob))
}

PUD.p<-OLS.reg("PUD","ud")
PUD.p[[2]]
TUD.p<-OLS.reg("TUD","ud")
TUD.p[[2]]
DC.p<-OLS.reg("DC","ud")
DC.p[[2]]
